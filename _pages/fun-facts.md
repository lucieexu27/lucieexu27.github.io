...
<div style="display: flex; flex-wrap: wrap; gap: 1em; justify-content: center; align-items: flex-start;">
  <figure style="flex: 0 1 300px; min-width: 200px; max-width: 300px; margin: 0;">
    <img src="/images/running2.jpg" alt="Running with fellow Atlanta Track Club ambassadors" style="width: 100%; display: block;">
    <figcaption>Running with fellow Atlanta Track Club ambassadors.</figcaption>
  </figure>
  <figure style="flex: 0 1 300px; min-width: 200px; max-width: 300px; margin: 0;">
    <img src="/images/running1.jpeg" alt="First marathon" style="width: 100%; display: block;">
...
<div style="display: flex; flex-wrap: wrap; gap: 1em; justify-content: center; align-items: flex-start;">
  <figure style="flex: 0 1 300px; min-width: 200px; max-width: 300px; margin: 0;">
    <img src="/images/quintet.jpg" alt="Chamber music in college" style="width: 100%; display: block;">
    <figcaption>My chamber music group at Georgetown.</figcaption>
  </figure>
  <figure style="flex: 0 1 300px; min-width: 200px; max-width: 300px; margin: 0;">
    <img src="/images/yoyoma.JPG" alt="Soundchecking for Yo-Yo Ma" style="width: 100%; display: block;">
...
<div style="display: flex; flex-wrap: wrap; gap: 1em; justify-content: center; align-items: flex-start;">
  <figure style="flex: 0 1 250px; min-width: 180px; max-width: 250px; margin: 0;">
    <img src="/images/paris.jpg" alt="Sunset in Paris" style="width: 100%; display: block;">
